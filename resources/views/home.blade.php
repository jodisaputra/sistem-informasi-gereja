        ...
        <section
            ...
            <div class="mx-auto max-w-[1280px]">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <p class="text-primary font-bold text-sm uppercase tracking-widest mb-1">Welcome back,
                            {{ Auth::user()->name }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <x-dashboard-card>
                        ...
                        <div class="space-y-3">
                            <a class="block p-3 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-200"
                                href="#">
                    ...
                    <x-dashboard-card>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center p-2 text-sm border-b border-gray-100">
                                <div>
    ...
    <section class="py-24 px-6 md:px-20 bg-white">
        <div class="mx-auto max-w-[1280px]">
            <div class="mb-16 text-center">
                <h2 class="font-serif text-4xl font-bold mb-4 text-[#111418]">Jadwal Ibadah Minggu Ini</h2>
    ...
    <section class="py-24 px-6 md:px-20 bg-white">
        <div class="mx-auto max-w-[1280px]">
            <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
                <div class="max-w-xl">
                    <h2 class="font-serif text-4xl font-bold mb-4 text-[#111418]">Events & News</h2>
                    <p class="text-[#617589]">Ikuti perkembangan terbaru dan jangan lewatkan kesempatan
